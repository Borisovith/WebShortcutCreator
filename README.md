...
3. Follow the installer prompts — it will automatically register the native host in the Registry for your Chromium browsers.
...
- No Python runtime required — host and setup tools are fully compiled executable binaries.
...
## 📂 Repository Contents
- **Host Installer Source:** `setup.exe`, `setup.py`, `assembly.md`, `WebShortcutCreator.ico`
